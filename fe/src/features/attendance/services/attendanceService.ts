...
export const getAllAttendanceRecordsForAdmin = async (
  ...
  page: number = 1,
  size: number = 15
): Promise<AttendanceAdminPageResponse> => {
  ...
  const response: AttendanceAdminPageResponse =
    await apiClient<AttendanceAdminPageResponse>(urlWithQuery, {
      method: "GET",
