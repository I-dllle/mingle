...
export default function MarketingNoticesPage() {
  const { name: userDepartment } = useDepartment();
  const menus = departmentMenus[userDepartment] || departmentMenus.default;
  const currentMenu = menus.find((menu) => menu.path === "/marketing-notices");
  ...
  console.log("Looking for path:", "/marketing-notices");
  ...
  const handlePostClick = async (postId: number) => {
    ...
    try {
      setNavigating(true);
      const targetUrl = `/marketing-notices/${postId}`;
