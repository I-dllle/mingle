...
export default function SnsContentPage() {
  ...
  const currentMenu = menus.find((menu) => menu.path === "/sns-content");
  ...
  console.log("Looking for path:", "/sns-content");
  ...
  const handlePostClick = async (postId: number) => {
    ...
    try {
      setNavigating(true);
      const targetUrl = `/sns-content/${postId}`;
