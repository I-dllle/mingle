...
export default function LegalDisputesDetailPage() {
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-4xl">
          <div className="text-center py-12">
            <p className="text-gray-600">법률 분쟁 내역을 찾을 수 없습니다.</p>
            <button
              onClick={() => router.back()}
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              >
                ...
                <span className="font-medium">법률 분쟁 내역 목록</span>
              </button>
              {/* 브레드크럼 */}
              <nav className="flex items-center space-x-2 text-sm">
                <span className="text-gray-500">재무법무팀</span>
                <span className="text-gray-300">/</span>
                <span className="text-gray-500">법률 분쟁 내역</span>
                <span className="text-gray-300">/</span>
