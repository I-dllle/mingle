        ...
        <div className="container mx-auto px-4 py-8 max-w-4xl">
          <div className="flex items-center justify-center h-64">
            <div className="text-center">
              ...
              <p className="mt-4 text-gray-600">내부 규정을 불러오는 중...</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-4xl">
          <div className="text-center py-12">
            <p className="text-gray-600">내부 규정을 찾을 수 없습니다.</p>
            <button
              onClick={() => router.back()}
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              >
                ...
                <span className="font-medium">내부 규정 목록</span>
              </button>
              {/* 브레드크럼 */}
              <nav className="flex items-center space-x-2 text-sm">
                <span className="text-gray-500">재무법무팀</span>
                <span className="text-gray-300">/</span>
                <span className="text-gray-500">내부 규정</span>
                <span className="text-gray-300">/</span>
