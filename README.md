...
- **아티스트/매니저**
   ...
   - **캘린더 일정관리 CRUD**
      - 스케줄 열람/등록/수정/삭제 
      - 개인 스케줄 이력 관리 출석, 이동 시간, 교통 수단, 숙소 정보 등 메모
      - 회의실, 연습실 예약 

- **스태프(기획/제작/정산/홍보)**
   - **게시글 CRUD**
      - 기획팀 - A&R 아티스트 등록, 팀/유닛 구성, 활동 기획 입력
      - 콘텐츠팀 - 음원, 영상, 보도자료, 앨범 커버 등 자료 업로드
      - 정산/법무팀 - 수익 정산 내역 등록, 계약서 업로드, 갱신 관리
      - 마케팅/홍보팀 - SNS 콘텐츠 계획, 팬이벤트 기획/이력 관리
      - 경영진 / 관리자 전체 통계 대시보드, 모든 콘텐츠/정산 열람 가능
   - **회의실 예약**
 ...
 | 이은서   |  <img src="" width="100">    |<ul><li>(1) </li><li>게시판 CRUD</li><li>(2)</li><li>(3)</li></ul>  |
 | 최정인    |  <img src="" width="100">    | <ul><li>(1)</li><li>(2)</li><li>(3)</li></ul>    |
