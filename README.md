...
- 프로젝트 이름: Mingle
- 프로젝트 설명: Mingle은 엔터테인먼트 기업 내 다양한 부서, 아티스트, 그리고 내부 구성원들이 유기적으로 협업할 수 있도록 설계된 올인원 그룹웨어 플랫폼입니다.
              실시간 채팅, 콘텐츠 관리, 정산 시스템, 일정 및 근태 관리, 회의실/연습실 예약, 굿즈샵까지 하나로 통합하여
              기획부터 실행, 관리, 공유까지 모든 업무를 한 공간에서 효율적으로 처리할 수 있는 환경을 제공합니다.
