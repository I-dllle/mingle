...
public class PostMenuInitializer implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        try {
            ...
            //관리팀
            initializeMenu("NOTICEBOARD_MANAGEMENT", "공지사항 관리", "관리자 - 공지사항 관리", "System Operations", creator);
            initializeMenu("USER_MANAGEMENT", "사용자 관리", "관리자 - 사용자 계정 관리", "System Operations", creator);
            initializeMenu("ATTENDANCE_MANAGEMENT", "근태관리", "관리자 - 근태 관리", "System Operations", creator);
            initializeMenu("DASHBOARD", "대시보드", "관리자 - 대시보드 시각화 요약", "System Operations", creator);
            initializeMenu("SETTLEMENT_MANAGEMENT", "정산관리", "관리자 - 정산 내역 관리", "System Operations", creator);
            initializeMenu("CONTRACT_MANAGEMENT", "계약서관리", "관리자 - 계약 문서 관리", "System Operations", creator);
